...
<body>
    ...
    <main>
        <div class="sidebar">
            <ul class="sidebar">
                <li class="sidebar-li link-demo">Lorem Ipsum</li>
                <li class="sidebar-li link-demo">Dolorem</li>
                <li class="sidebar-li link-demo">Est Amet</li>
                <li class="sidebar-li link-demo">Sit Dolor</li>
                <li class="sidebar-li link-demo">Nonumy</li>
                <li class="sidebar-li link-demo">Tempor invidunt</li>
            </ul>
        </div>
        <div class="content">
