...
<body>
    ...
    <main>
        <div class="sidebar">
            <ul class="sidebar">
                <li class="sidebar-li link-demo">Hunde</li>
                <li class="sidebar-li link-demo">Katzen</li>
                <li class="sidebar-li link-demo">Andere Tiere</li>
                <li class="sidebar-li link-demo">Weiße Schnauzen</li>
                <li class="sidebar-li link-demo">Vermisste Tiere</li>
            </ul>
        </div>
        <div class="content">
            <div class="content-wrapper">
                <div id="zg">
                    <h1>Zuhause Gefunden</h1>
